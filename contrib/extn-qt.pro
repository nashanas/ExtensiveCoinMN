...
RESOURCES += src/qt/extn.qrc src/qt/extn_locale.qrc

TRANSLATIONS += src/qt/locale/extn_bg.ts \
                src/qt/locale/extn_de.ts \
                src/qt/locale/extn_en.ts \
                src/qt/locale/extn_es.ts \
                src/qt/locale/extn_fi.ts \
                src/qt/locale/extn_fr.ts \
                src/qt/locale/extn_it.ts \
                src/qt/locale/extn_ja.ts \
                src/qt/locale/extn_pl.ts \
                src/qt/locale/extn_pt.ts \
                src/qt/locale/extn_ru.ts \
                src/qt/locale/extn_sk.ts \
                src/qt/locale/extn_sv.ts \
                src/qt/locale/extn_vi.ts \
                src/qt/locale/extn_zh_CN.ts \
                src/qt/locale/extn_zh_TW.ts
