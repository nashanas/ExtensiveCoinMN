...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"extn", "masternode", &masternode, true, true, false},
        {"extn", "masternodelist", &masternodelist, true, true, false},
        {"extn", "mnbudget", &mnbudget, true, true, false},
        {"extn", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"extn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"extn", "mnsync", &mnsync, true, true, false},
        {"extn", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"extn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use extnd, or the -server option to extn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> extn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24056/\n";
}
