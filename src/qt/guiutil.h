...
/** Utility functions used by the ExtensiveCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ExtensiveCoin addresses in monospace font
...
// Parse "extn:" URI into recipient object, return true on successful parsing
