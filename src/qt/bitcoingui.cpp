                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ExtensiveCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ExtensiveCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and extn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ExtensiveCoin"), this);
    aboutAction->setStatusTip(tr("Show information about ExtensiveCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ExtensiveCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ExtensiveCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ExtensiveCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ExtensiveCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ExtensiveCoin help message to get a list with possible ExtensiveCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ExtensiveCoin client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("ExtensiveCoin"); // default title
