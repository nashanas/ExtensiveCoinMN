...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ExtensiveCoin"),
     ...
     * override -datadir in the ExtensiveCoin.conf file in the default data directory
     * (to be consistent with extnd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
