...
The following applies to code changes to the EXTN Core project, and is not to be
confused with overall EXTN Network Protocol consensus changes.

Whether a pull request is merged into EXTN Core rests with the project merge
...
Patches that change EXTN consensus rules are considerably more involved than
...
Where a patch set proposes to change the EXTN consensus, it must have been
...
The project leader is the release manager for each EXTN Core release.
