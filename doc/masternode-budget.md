...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<extn_address\> \<monthly_payment_extn\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ EXTN, _12_ times over the course of a year totaling _24000_ EXTN.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<extn_address\> \<monthly_payment_extn\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` EXTN.
