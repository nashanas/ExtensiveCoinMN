...
In order to support loading of multiple wallets in extn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is extn.cpp.
...
Changes to extn.cpp
----------------------
extn.cpp is the entry point into extn-qt, and as such, will require some minor modifications to provide hooks for
