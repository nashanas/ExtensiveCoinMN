...
This mechanism has been integrated into Bitcore-Node-EXTN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EXTN-Project/insight-api-extn#web-socket-api](https://github.com/EXTN-Project/insight-api-extn#web-socket-api)
* API: [https://github.com/EXTN-Project/insight-api-extn#swifttx-transactions](https://github.com/EXTN-Project/insight-api-extn#swifttx-transactions)
...
By default, the EXTN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EXTN Core daemon:
